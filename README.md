...
> Простое приложение для расчёта площадей прямоугольников с поддержкой множителей, историей вычислений, которое я сделал для своих нужд с помощью нейросети DeepSeek. <!-- и тёмной темой. -->
...
|--------------|-------------|
| ![Светлая тема](screenshot-light.png) | ![Тёмная тема](screenshot-dark.png) |
...
- 🪟 **Кастомное окно** — без нативного меню, с собственными кнопками управления
...
| Канал | Ссылка |
|-------|--------|
| **Issues** | [GitHub Issues](https://github.com/nklnke/area-calculator/issues) |
| **Email** | megacokes@gmail.com |
...
**Сделано с ❤️ для удобных расчётов**